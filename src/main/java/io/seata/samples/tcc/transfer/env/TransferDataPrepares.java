...
public class TransferDataPrepares {
    ...
    protected void prepareTable(DataSource dataSource) {
        ...
        try {
            ...
            s.execute("CREATE TABLE  business_activity  ( \n" +
            ...
            s.execute("CREATE TABLE  business_action (  \n" +
                    "tx_id  varchar(128) ,\n" +
            ...
            s.execute(
                "create table account(account_no varchar(128), amount DOUBLE,  freezed_amount DOUBLE)");
